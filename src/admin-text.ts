...
export function getAdminMaintenanceText(locale: Locale) {
  if (locale === "zh") {
    ...
    return {
      ...
      turnstileDescription: "用于保护管理员登录和前端工具提交，减少恶意尝试；请在项目配置下方两个环境变量，即可开启或关闭，密钥不会在后台显示。",
  ...
  return {
    ...
    turnstileTitle: "Cloudflare Turnstile",
    turnstileDescription: "Protects admin login and public tool submissions while reducing malicious attempts. Configure both variables below in the project to enable or disable it; secrets are never shown in the admin interface.",
